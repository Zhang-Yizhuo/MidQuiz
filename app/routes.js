...
module.exports = function(app, passport) {
	...
	var questions = [
		{question: "This is q1", option1: "A", option2: "B", answer: "A", id: 1},
		{question: "This is q2", option1: "C", option2: "D", answer: "C", id: 2}
	]
	...
	app.post('/quiz', isLoggedIn, function(req, res) {
		...
		res.render('results.ejs', {
			responses: [responses[0].response, responses[1].response],
			answers: answers,
			score: 0
		});
